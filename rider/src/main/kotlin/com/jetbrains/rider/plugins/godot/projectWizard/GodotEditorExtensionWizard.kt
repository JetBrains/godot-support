...
class GodotEditorExtensionWizard : GeneratorNewProjectWizard, RiderProjectWizardMode {

    override val id: String = "Rider.GodotEditorExtension"

    override val name: String = GodotPluginBundle.message("wizard.godot.editor.extension.name")

    override val icon: Icon = GodotIcons.Icons.GodotLogoGray

    override val ordinal: Int = 200

    override val description: String = GodotPluginBundle.message("wizard.godot.editor.extension.description")
    ...
    override fun createStep(context: WizardContext): NewProjectWizardStep =
        RootNewProjectWizardStep(context)
            .nextStep { riderNewProjectWizardBaseStep(it).also { step -> step.defaultName = "MyEditorExtension" } }
            .nextStep { RiderGitNewProjectWizardStep(it, defaultEnabled = true) }
            .nextStep(::GodotEditorExtensionAssetsStep)
}
