...
class GodotGameExtensionAssetsStep(parent: NewProjectWizardStep) : RiderAbstractNewProjectWizardStep(parent) {
  ...
  override fun setupProject(project: Project) {
    ...
    ApplicationManager.getApplication().runWriteAction {
      ...
      writeFile(projectDir, "project.godot", "templates/godotGameExtension/project.godot.ft", projectName)

      // Addon files (no plugin.cfg, no addon.gd)
      ...
      binDir?.let { writeFile(it, "$projectName.gdextension", "templates/godotGameExtension/addon/bin/addon.gdextension.ft", projectName) }
      ...
      if (cppDir != null) {
        ...
        if (srcDir != null) {
          ...
          writeFile(srcDir, "register_types.cpp", "templates/godotGameExtension/addon/cpp/src/register_types.cpp")
