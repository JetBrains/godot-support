...
// relative path called "test/data".
...
namespace JetBrains.ReSharper.Plugins.Godot.Tests
{
    ...
    [ZoneDefinition]
    public interface IRiderGodotTestsEnvZone : ITestsEnvZone
    {
    }
    ...
    [ZoneDefinition]
    public interface IGodotTestZone : IZone,
    ...
    [ZoneActivator]
    [ZoneMarker(typeof(IRiderGodotTestsEnvZone))]
    public class GodotTestZonesActivator : IActivate<IGodotTestZone>
    {
    }

    [SetUpFixture]
    public class TestEnvironment : ExtensionTestEnvironmentAssembly<IRiderGodotTestsEnvZone>
    {
