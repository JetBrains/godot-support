...
public class TscnValueImpl extends ASTWrapperPsiElement implements TscnValue {
  ...
  @Override
  @Nullable
  public TscnJson getJson() {
    return PsiTreeUtil.getChildOfType(this, TscnJson.class);
  }
