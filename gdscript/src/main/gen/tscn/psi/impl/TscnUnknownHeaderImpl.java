...
public class TscnUnknownHeaderImpl extends TscnHeaderImpl implements TscnUnknownHeader {

  public TscnUnknownHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TscnVisitor visitor) {
    visitor.visitUnknownHeader(this);
  }
