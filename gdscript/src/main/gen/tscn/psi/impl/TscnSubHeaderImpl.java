...
public class TscnSubHeaderImpl extends TscnHeaderImpl implements TscnSubHeader {

  public TscnSubHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TscnVisitor visitor) {
    visitor.visitSubHeader(this);
  }
