...
public class ConfigOperatorNmImpl extends ASTWrapperPsiElement implements ConfigOperatorNm {

  public ConfigOperatorNmImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ConfigVisitor visitor) {
    visitor.visitOperatorNm(this);
  }
