...
public class ConfigLeftTypeImpl extends ASTWrapperPsiElement implements ConfigLeftType {

  public ConfigLeftTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ConfigVisitor visitor) {
    visitor.visitLeftType(this);
  }
