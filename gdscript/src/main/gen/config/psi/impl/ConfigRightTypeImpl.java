...
public class ConfigRightTypeImpl extends ASTWrapperPsiElement implements ConfigRightType {

  public ConfigRightTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ConfigVisitor visitor) {
    visitor.visitRightType(this);
  }
