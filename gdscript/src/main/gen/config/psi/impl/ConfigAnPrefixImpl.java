...
public class ConfigAnPrefixImpl extends ASTWrapperPsiElement implements ConfigAnPrefix {

  public ConfigAnPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ConfigVisitor visitor) {
    visitor.visitAnPrefix(this);
  }
