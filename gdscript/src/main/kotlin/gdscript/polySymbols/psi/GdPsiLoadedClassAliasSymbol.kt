 ...
 * ```
 *
 * The [sourceElement] is the name-identifier (`GdVarNmi`) of the var/const declaration.
 * Navigate up via [sourceElement].parent to reach the full declaration and resolve the loaded class.
 *
