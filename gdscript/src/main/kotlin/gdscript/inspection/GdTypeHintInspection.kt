...
class GdTypeHintInspection : LocalInspectionTool() {
    ...
    private fun checkTypeHint(element: PsiElement, holder: ProblemsHolder) {
        ...
        holder.registerWeakWarning(
            ...
            GdAddVariableTypeHintFix(element, realType, true),
            GdAddVariableTypeHintFix(element, realType, false)
        )
    }
