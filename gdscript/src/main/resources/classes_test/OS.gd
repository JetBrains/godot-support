...
var low_processor_usage_mode: bool setget set_low_processor_usage_mode, is_in_low_processor_usage_mode;
var low_processor_usage_mode_sleep_usec: int setget set_low_processor_usage_mode_sleep_usec, get_low_processor_usage_mode_sleep_usec;
