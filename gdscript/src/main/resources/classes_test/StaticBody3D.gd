...
var constant_angular_velocity: Vector3 setget set_constant_angular_velocity, get_constant_angular_velocity;
var constant_linear_velocity: Vector3 setget set_constant_linear_velocity, get_constant_linear_velocity;
