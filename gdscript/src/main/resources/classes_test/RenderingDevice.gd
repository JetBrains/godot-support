...
const DATA_FORMAT_PVRTC1_2BPP_UNORM_BLOCK_IMG = 218;
const DATA_FORMAT_PVRTC1_4BPP_UNORM_BLOCK_IMG = 219;
const DATA_FORMAT_PVRTC2_2BPP_UNORM_BLOCK_IMG = 220;
const DATA_FORMAT_PVRTC2_4BPP_UNORM_BLOCK_IMG = 221;
const DATA_FORMAT_PVRTC1_2BPP_SRGB_BLOCK_IMG = 222;
const DATA_FORMAT_PVRTC1_4BPP_SRGB_BLOCK_IMG = 223;
const DATA_FORMAT_PVRTC2_2BPP_SRGB_BLOCK_IMG = 224;
const DATA_FORMAT_PVRTC2_4BPP_SRGB_BLOCK_IMG = 225;
const DATA_FORMAT_MAX = 226;
...
const TEXTURE_USAGE_RESOLVE_ATTACHMENT_BIT = 512;
