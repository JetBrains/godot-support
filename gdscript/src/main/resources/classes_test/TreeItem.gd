...
var custom_minimum_height: int setget set_custom_minimum_height, get_custom_minimum_height;
var disable_folding: bool setget set_disable_folding, is_folding_disabled;
