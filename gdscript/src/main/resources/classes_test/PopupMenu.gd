...
var allow_search: bool setget set_allow_search, get_allow_search;
var hide_on_checkable_item_selection: bool setget set_hide_on_checkable_item_selection, is_hide_on_checkable_item_selection;
var hide_on_item_selection: bool setget set_hide_on_item_selection, is_hide_on_item_selection;
var hide_on_state_item_selection: bool setget set_hide_on_state_item_selection, is_hide_on_state_item_selection;
var submenu_popup_delay: float setget set_submenu_popup_delay, get_submenu_popup_delay;
