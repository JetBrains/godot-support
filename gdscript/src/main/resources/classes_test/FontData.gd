...
var data_path: String setget set_data_path, get_data_path;
var distance_field_hint: bool setget set_distance_field_hint, get_distance_field_hint;
var extra_spacing_glyph: int setget set_spacing, get_spacing;
var extra_spacing_space: int setget set_spacing, get_spacing;
var force_autohinter: bool setget set_force_autohinter, get_force_autohinter;
var hinting: int setget set_hinting, get_hinting;
