...
var emission_normals: PackedVector2Array setget set_emission_normals, get_emission_normals;
var emission_points: PackedVector2Array setget set_emission_points, get_emission_points;
var emission_rect_extents: Vector2 setget set_emission_rect_extents, get_emission_rect_extents;
...
var gravity: Vector2 setget set_gravity, get_gravity;
