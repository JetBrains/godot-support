...
var damping: float setget set_damping, get_damping;
var gravity: Vector2 setget set_gravity, get_gravity;
var jiggle_data_chain_length: int setget set_jiggle_data_chain_length, get_jiggle_data_chain_length;
var mass: float setget set_mass, get_mass;
var stiffness: float setget set_stiffness, get_stiffness;
var target_nodepath: NodePath setget set_target_node, get_target_node;
var use_gravity: bool setget set_use_gravity, get_use_gravity;
