...
func operator !=(right: Vector2) -> bool:
    pass;

func operator *(right: Vector2) -> Vector2:
    pass;

func operator *(right: Transform2D) -> Vector2:
    pass;

func operator *(right: float) -> Vector2:
    pass;

func operator *(right: int) -> Vector2:
    pass;
