...
func get_connection_binds() -> Array:
	pass;
...
func get_node_groups() -> PackedStringArray:
	pass;
...
func get_node_instance_placeholder() -> String:
	pass;
...
func get_node_owner_path() -> NodePath:
	pass;
...
func get_node_property_count() -> int:
	pass;
...
func is_node_instance_placeholder() -> bool:
	pass;
