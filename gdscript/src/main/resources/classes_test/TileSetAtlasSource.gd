...
var margins: Vector2i setget set_margins, get_margins;
var separation: Vector2i setget set_separation, get_separation;
var texture: Texture2D setget set_texture, get_texture;
var tile_size: Vector2i setget set_texture_region_size, get_texture_region_size;
