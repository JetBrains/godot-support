...
func add_bind(bone: int, pose: Transform3D) -> void:
	pass;

func add_named_bind(name: String, pose: Transform3D) -> void:
	pass;
...
func set_bind_pose(bind_index: int, pose: Transform3D) -> void:
	pass;
