...
var basis: Basis setget , ;
var origin: Vector3 setget , ;
...
func operator !=(right: Transform3D) -> bool:
    pass;

func operator *(right: PackedVector3Array) -> PackedVector3Array:
    pass;

func operator *(right: Transform3D) -> Transform3D:
    pass;

func operator *(right: AABB) -> AABB:
    pass;

func operator *(right: Vector3) -> Vector3:
    pass;

func operator *(right: float) -> Transform3D:
    pass;

func operator *(right: int) -> Transform3D:
    pass;
