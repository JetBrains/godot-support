...
var debug_shape_custom_color: Color setget set_debug_shape_custom_color, get_debug_shape_custom_color;
var debug_shape_thickness: float setget set_debug_shape_thickness, get_debug_shape_thickness;
