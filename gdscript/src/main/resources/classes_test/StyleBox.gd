...
var content_margin_bottom: float setget set_default_margin, get_default_margin;
var content_margin_left: float setget set_default_margin, get_default_margin;
var content_margin_right: float setget set_default_margin, get_default_margin;
var content_margin_top: float setget set_default_margin, get_default_margin;
