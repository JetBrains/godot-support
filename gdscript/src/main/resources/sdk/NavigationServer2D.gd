...
func link_set_end_location(link: RID, location: Vector2) -> void:
	pass;
...
func link_set_start_location(link: RID, location: Vector2) -> void:
	pass;
...
func map_get_path(map: RID, origin: Vector2, destination: Vector2, optimize: bool, navigation_layers: int) -> PackedVector2Array:
	pass;
