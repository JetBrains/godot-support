...
func _shaped_text_add_object(shaped: RID, key: Variant, size: Vector2, inline_align: int, length: int) -> bool:
	pass;
...
func _shaped_text_resize_object(shaped: RID, key: Variant, size: Vector2, inline_align: int) -> bool:
	pass;
...
func _string_get_word_breaks(string: String, language: String) -> PackedInt32Array:
	pass;
