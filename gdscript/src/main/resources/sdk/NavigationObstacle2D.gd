extends Node
#brief 2D Obstacle used in navigation for collision avoidance.
#desc 2D Obstacle used in navigation for collision avoidance. The obstacle needs navigation data to work correctly. [NavigationObstacle2D] is physics safe.
...
#desc Returns the [RID] of this obstacle on the [NavigationServer2D].
func get_rid() -> RID:
	pass;
