...
class GdGodotTest : ParsingTestCase("", "gd", GdParserDefinition()) {
    ...
    @Mute("RIDER-126458") @Test fun testadvanced_expression_matching() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testallow_strings_as_comments() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testannotations() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testbitwise_operators() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testdollar_and_percent_get_node() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testgood_continue_in_lambda() = doTest(true, true)
    @Test fun testif_after_lambda() = doTest(true, true)
    @Test fun testin() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testis_not_operator() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testlambda_ends_with_new_line() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testlambda_named_callable() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testmatch() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testmatch_array() = doTest(true, true)
    @Test fun testmatch_bind_unused() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testmatch_dictionary() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testmultiline_strings() = doTest(true, true)
    @Test fun testmultiline_vector() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testnested_arithmetic() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testnumber_literals_with_sign() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testnumber_separators() = doTest(true, true)
    @Test fun testoperator_assign() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testproperty_setter_getter() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testreserved_keywords_as_attribute() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testr_strings() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testsemicolon_as_end_statement() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testsemicolon_as_terminator() = doTest(true, true)
    @Test fun testsignal_declaration() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun testsingle_line_declaration() = doTest(true, true)
    @Test fun testspace_indentation() = doTest(true, true)
    @Mute("RIDER-126458") @Test fun teststatic_typing() = doTest(true, true)
    ...
    @Mute("RIDER-126458") @Test fun testunicode_identifiers() = doTest(true, true)
