...
class GdGodotTest : GdParsingTestCase() {
    ...
    @Test fun testlambdaAsArgument() = doTest(true, true)
    @Test fun testlambdaAsArgumentReturnLastArg() = doTest(true, true)
    @Test fun testlambdaAsArgumentReturnCommaNextLine() = doTest(true, true)
    @Test fun testlambdaAsArgumentReturnMultiStmt() = doTest(true, true)
    @Test fun testlambdaAsArgumentReturnNestedIf() = doTest(true, true)
    @Test fun testlambdaAsArgumentNestedIfElse() = doTest(true, true)
    ...
    @Test fun testsemicolon_separated_statements_one_line() = doTest(true, true)
    @Test fun testsemicolon_multiple_after_statement_suite() = doTest(true, true)
    @Test fun testsemicolon_multiple_alone_suite() = doTest(true, true)
    @Test fun testsemicolon_multiple_on_one_line() = doTest(true, true)
