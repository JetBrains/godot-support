...
class GdGodotTestCases : ParsingTestCase("", "gd", gdscript.GdParserDefinition()) {
    ...
    @Test fun testannotations() = doTest(true, true)
    ...
    @Test fun testbitwise_operators() = doTest(true, true)
    ...
    @Test fun testdollar_and_percent_get_node() = doTest(true, true)
    ...
    @Test fun testfloat_notation() = doTest(true, true)
    ...
    @Test fun testgood_continue_in_lambda() = doTest(true, true)
    ...
    @Test fun testmatch() = doTest(true, true)
    @Test fun testmatch_array() = doTest(true, true)
    @Test fun testmatch_bind_unused() = doTest(true, true)
    @Test fun testmatch_dictionary() = doTest(true, true)
    ...
    @Test fun testnested_arithmetic() = doTest(true, true)
    ...
    @Test fun testnumber_literals_with_sign() = doTest(true, true)
    @Test fun testnumber_separators() = doTest(true, true)
    @Test fun testoperator_assign() = doTest(true, true)
    @Test fun testproperty_setter_getter() = doTest(true, true)
    @Test fun testreserved_keywords_as_attribute() = doTest(true, true)
    @Test fun testr_strings() = doTest(true, true)
    @Test fun testsemicolon_as_end_statement() = doTest(true, true)
    @Test fun testsemicolon_as_terminator() = doTest(true, true)
    @Test fun testsignal_declaration() = doTest(true, true)
    @Test fun testsingle_line_declaration() = doTest(true, true)
    @Test fun testspace_indentation() = doTest(true, true)
    @Test fun teststatic_typing() = doTest(true, true)
    ...
    @Test fun testvector_inf() = doTest(true, true)
    @Test fun testwhile() = doTest(true, true)

    override fun getTestDataPath(): String {
        return "src/test/kotlin/gdscript/parser/godotTestCases"
    }
